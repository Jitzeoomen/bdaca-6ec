...
\title[Big Data and Automated Content Analysis]{\textbf{Big Data \& Automated Content Analysis} \\ Week 2 -- Thursday: »Programming concepts for data analysis«}
...
\begin{frame}{Recap -- Last week}
		...
		\item Your computer and operating system: your responsibility.
		\item Make sure you can run a Jupyter Notebook, install packages, navigate to files in Jupyer Notebook. 
		\item If this does not work: \href{https://github.com/damian0604/bdaca/blob/master/book/bd-aca book.pdf}{Install a VM}
		\item Instructional video notebook lab meeting \#1 on Canvas
